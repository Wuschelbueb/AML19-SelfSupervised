...
def autoencoder_subtask_fashion_MNIST():
    ...
    encoder_trained, decoder_trained, train_losses = train_autoencoder_mnist()
    ...
    encoder_ft, decoder_ft, classifier_ft, train_losses_ft, val_losses_ft, train_acc_ft, val_acc_ft = transfer_learning_autoencoder_mnist(encoder_trained, decoder_trained)
    ...
    average_test_loss, average_test_accuracy = test_autoencoder_mnist(encoder_ft, decoder_ft, classifier_ft)
