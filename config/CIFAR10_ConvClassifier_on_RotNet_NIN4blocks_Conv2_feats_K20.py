...
data_train_opt['dataset_name'] = 'fashionMNIST'
...
data_test_opt['dataset_name'] = 'fashionMNIST'
...
feat_pretrained_file = './experiments/FashionMNIST_RotNet_NIN4blocks/model_net_epoch200'
